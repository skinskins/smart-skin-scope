...
const zoneResults: ZoneResult[] = [
  {
    id: "forehead", label: "Front", score: 85, status: "good", trend: "up",
    summary: "Texture régulière, grain de peau affiné",
    detail: "La texture de votre front est très bonne avec un grain de peau régulier et une bonne hydratation globale. Pas de signe de déshydratation sévère.",
    tips: ["Maintenir l'hydratation actuelle", "Continuer la protection solaire quotidienne"],
    image: zoneForehead,
  },
  {
    id: "left-cheek", label: "Joue gauche", score: 75, status: "good", trend: "stable",
    summary: "Pores légèrement visibles, belle luminosité",
    detail: "La peau présente une bonne clarté. On observe une légère dilatation naturelle des pores et de très discrètes rougeurs, sans inflammation.",
    tips: ["Privilégier un nettoyage doux", "Intégrer de la niacinamide pour resserrer les pores"],
    image: zoneLeftCheek,
  },
  {
    id: "right-cheek", label: "Joue droite", score: 72, status: "good", trend: "up",
    summary: "Texture saine, quelques irrégularités",
    detail: "Texture globale saine. Quelques légères variations de texture en surface, tout à fait normales pour cette zone d'exposition.",
    tips: ["Sérum antioxydant léger", "Exfoliation enzymatique douce 1x/semaine"],
    image: zoneRightCheek,
  },
  {
    id: "tzone", label: "Zone T / Nez", score: 55, status: "warning", trend: "stable",
    summary: "Filaments sébacés, pores marqués",
    detail: "Présence visible de filaments sébacés et de pores dilatés sur le nez. La zone présente une surproduction modérée de sébum.",
    tips: ["Double nettoyage le soir (huile + gel)", "Exfoliant BHA (Acide Salicylique) 2-3x/semaine", "Éviter les crèmes trop riches sur cette zone"],
    image: zoneTzone,
  },
  {
    id: "chin", label: "Menton", score: 65, status: "warning", trend: "down",
    summary: "Texture légèrement granuleuse",
    detail: "La zone autour de la bouche et du menton montre une texture un peu inégale, avec de potentielles micro-imperfections sous-cutanées.",
    tips: ["Soin ciblé purifiant le soir", "Attention aux dentifrices ou baumes à lèvres irritants"],
    image: zoneChin,
  },
  {
    id: "jaw", label: "Mâchoire", score: 80, status: "good", trend: "stable",
    summary: "Barrière cutanée saine",
    detail: "Aucune congestion majeure détectée sur l'ovale du visage. La peau est souple et ne présente pas d'inflammation hormonale.",
    tips: ["Hydratation régulière", "Massage facial pour le drainage"],
    image: zoneJaw,
  },
];
